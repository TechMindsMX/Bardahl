...
<div id='div_buscar'>
    <form id="form_buscar"  name='form1' action='index.php?option=com_busqueda' method='post' enctype='multipart/form-data'
        ...
        <select name='kilometraje' id="kilometraje">
            <option>0 a 50,000 kms</option>
            <option>50,001 a 100,000 kms</option>
            <option>100,001 a 150,000 kms</option>
            <option>150,001 a 200,000 kms</option>
            <option>más de 200,001 kms</option>
        </select>
        <br>
        </fieldset>
