...
class PHPExcel_Best_Fit
{
	...
	public function getIntersectSE ($dp = 0) {
		if ($dp != 0) {
			return round ($this->_intersectSE,
						  $dp);
		}
	...
	public function getGoodnessOfFit ($dp = 0) {
		if ($dp != 0) {
			return round ($this->_goodnessOfFit,
						  $dp);
		}
	...
	public function getGoodnessOfFitPercent ($dp = 0) {
		if ($dp != 0) {
			return round ($this->_goodnessOfFit * 100,
						  $dp);
		}
	...
	public function getStdevOfResiduals ($dp = 0) {
		if ($dp != 0) {
			return round ($this->_stdevOfResiduals,
						  $dp);
		}
	...
	public function getSSRegression ($dp = 0) {
		if ($dp != 0) {
			return round ($this->_SSRegression,
						  $dp);
		}
	...
	public function getSSResiduals ($dp = 0) {
		if ($dp != 0) {
			return round ($this->_SSResiduals,
						  $dp);
		}
	...
	public function getDFResiduals ($dp = 0) {
		if ($dp != 0) {
			return round ($this->_DFResiduals,
						  $dp);
		}
	...
	public function getCorrelation ($dp = 0) {
		if ($dp != 0) {
			return round ($this->_correlation,
						  $dp);
		}
	...
	protected function _leastSquareFit ($yValues,
										$xValues,
										$const) {
		// calculate sums
...
//		$this->_intersect = ($y_sum - ($this->_slope * $x_sum)) / $this->_valueCount;
		...
		$this->_calculateGoodnessOfFit ($x_sum,
										$y_sum,
										$xx_sum,
										$yy_sum,
										$xy_sum,
	...
	protected function _calculateGoodnessOfFit ($sumX,
												$sumY,
												$sumX2,
												$sumY2,
												$sumXY,
		...
		$this->_correlation = ($this->_valueCount * $sumXY - $sumX * $sumY) / sqrt (($this->_valueCount * $sumX2 - pow ($sumX,
																														2)) * ($this->_valueCount * $sumY2 - pow ($sumY,
																																								  2)));
