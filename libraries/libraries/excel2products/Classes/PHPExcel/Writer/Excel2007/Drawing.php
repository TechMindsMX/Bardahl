...
//						$objWriter->endElement();
	...
	public function writeVMLHeaderFooterImages (PHPExcel_Worksheet $pWorksheet = null) {
		...
		$objWriter->writeAttribute ('v:ext',
									'edit');
		...
		$objWriter->writeAttribute ('coordsize',
									'21600,21600');
		$objWriter->writeAttribute ('o:spt',
									'75');
		$objWriter->writeAttribute ('o:preferrelative',
									't');
		$objWriter->writeAttribute ('path',
									'm@4@5l@4@11@9@11@9@5xe');
		$objWriter->writeAttribute ('filled',
									'f');
		$objWriter->writeAttribute ('stroked',
									'f');
		...
		foreach ($images as $key => $value) {
			$this->_writeVMLHeaderFooterImage ($objWriter,
											   $key,
											   $value);
		}
	 ...
	 * @throws    PHPExcel_Writer_Exception
	 */
	public function _writeVMLHeaderFooterImage (PHPExcel_Shared_XMLWriter $objWriter = null,
												$pReference = '',
		...
		$objWriter->writeAttribute ('o:relid',
									'rId' . $pReference);
		...
		$objWriter->writeAttribute ('v:ext',
									'edit');
		$objWriter->writeAttribute ('rotation',
									't');
		$objWriter->endElement ();
