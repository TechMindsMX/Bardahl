...
class PHPExcel_Writer_Excel2007_StringTable extends PHPExcel_Writer_Excel2007_WriterPart
{
	...
	public function writeRichText (PHPExcel_Shared_XMLWriter $objWriter = null,
		...
		foreach ($elements as $element) {
			...
			if ($element instanceof PHPExcel_RichText_Run) {
				...
				$objWriter->writeAttribute ('val',
					($element->getFont ()->getStrikethrough () ? 'true' : 'false'));
				$objWriter->endElement ();
	 ...
	 * @throws    PHPExcel_Writer_Exception
	 */
	public function writeRichTextForCharts (PHPExcel_Shared_XMLWriter $objWriter = null,
											$pRichText = null,
											$prefix = NULL) {
