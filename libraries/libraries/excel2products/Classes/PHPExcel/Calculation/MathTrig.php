...
class PHPExcel_Calculation_MathTrig
{
	 ...
	 */
	public static function ATAN2 ($xCoordinate = NULL,
								  $yCoordinate = NULL) {
	 ...
	 */
	public static function COMBIN ($numObjs,
								   $numInSet) {
	...
	public static function LCM () {
		...
		foreach (PHPExcel_Calculation_Functions::flattenArray (func_get_args ()) as $value) {
			...
			foreach ($myPoweredFactors as $myPoweredValue => $myPoweredFactor) {
				if (array_key_exists ($myPoweredValue,
									  $allPoweredFactors)) {
	 ...
	 * @return    float
	 */
	public static function LOG_BASE ($number = NULL,
									 $base = 10) {
		$number = PHPExcel_Calculation_Functions::flattenSingleValue ($number);
	 ...
	 * @return    array
	 */
	public static function MMULT ($matrixData1,
								  $matrixData2) {
	 ...
	 */
	public static function MOD ($a = 1,
								$b = 1) {
	 ...
	 * @return    float    Rounded Number
	 */
	public static function MROUND ($number,
								   $multiple) {
		$number = PHPExcel_Calculation_Functions::flattenSingleValue ($number);
	...
	public static function EVEN ($number) {
		...
		if (is_numeric ($number)) {
			...
			return (int)self::CEILING ($number,
									   $significance);
		}
		return PHPExcel_Calculation_Functions::VALUE ();
	}    //	function ODD()
	 ...
	 * @return    float
	 */
	public static function POWER ($x = 0,
								  $y = 2) {
	 ...
	 */
	public static function RAND ($min = 0,
								 $max = 0) {
	...
	public static function ROMAN ($aValue,
								  $style = 0) {
		...
		$m = self::_romanCut ($aValue,
							  1000);
		$aValue %= 1000;
		$c = self::_romanCut ($aValue,
							  100);
		$aValue %= 100;
		$t = self::_romanCut ($aValue,
							  10);
		$aValue %= 10;
	...
	private static function _romanCut ($num,
									   $n) {
		return ($num - ($num % $n)) / $n;
	}    //	function ROMAN()
	 ...
	 * @return    float
	 */
	public static function SUMIF ($aArgs,
								  $condition,
								  $sumArgs = array ()) {
		// Return value
		$returnValue = 0;
	 ...
	 * @return    float
	 */
	public static function SUMX2MY2 ($matrixData1,
									 $matrixData2) {
	 ...
	 * @return    float
	 */
	public static function SUMX2PY2 ($matrixData1,
									 $matrixData2) {
		$array1 = PHPExcel_Calculation_Functions::flattenArray ($matrixData1);
		$array2 = PHPExcel_Calculation_Functions::flattenArray ($matrixData2);
		$count1 = count ($array1);
	 ...
	 * @return    float
	 */
	public static function SUMXMY2 ($matrixData1,
									$matrixData2) {
		$array1 = PHPExcel_Calculation_Functions::flattenArray ($matrixData1);
		$array2 = PHPExcel_Calculation_Functions::flattenArray ($matrixData2);
		$count1 = count ($array1);
	 ...
	 */
	public static function TRUNC ($value = 0,
								  $digits = 0) {
