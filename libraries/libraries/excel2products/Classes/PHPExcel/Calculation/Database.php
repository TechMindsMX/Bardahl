...
class PHPExcel_Calculation_Database
{
	 ...
	 *
	 */
	public static function DAVERAGE ($database,
									 $field,
									 $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
		if (is_null ($field)) {
			return NULL;
		}
		//	reduce the database to a set of rows that match all the criteria
		$database = self::__filter ($database,
									$criteria);
	 ...
	 *
	 */
	private static function __fieldExtract ($database,
											$field) {
	 ...
	 *
	 */
	private static function __filter ($database,
									  $criteria) {
	 ...
	 *
	 */
	public static function DCOUNT ($database,
								   $field,
								   $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DCOUNTA ($database,
									$field,
									$criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DGET ($database,
								 $field,
								 $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DMAX ($database,
								 $field,
								 $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DMIN ($database,
								 $field,
								 $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DPRODUCT ($database,
									 $field,
									 $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DSTDEV ($database,
								   $field,
								   $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DSTDEVP ($database,
									$field,
									$criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DSUM ($database,
								 $field,
								 $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DVAR ($database,
								 $field,
								 $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
	 ...
	 *
	 */
	public static function DVARP ($database,
								  $field,
								  $criteria) {
		$field = self::__fieldExtract ($database,
									   $field);
