...
class PHPExcel
{
	 ...
	 *
	 */
	public function setRibbonXMLData ($Target = NULL,
									  $XMLData = NULL) {
	 ...
	 * @throws PHPExcel_Exception
	 */
	public function addSheet (PHPExcel_Worksheet $pSheet,
							  $iSheetIndex = NULL) {
	...
	public function removeSheetByIndex ($pIndex = 0) {
		...
		if ($pIndex > $numSheets - 1) {
			...
			array_splice ($this->_workSheetCollection,
						  $pIndex,
						  1);
		}
		// Adjust active sheet index if necessary
	 ...
	 * @throws PHPExcel_Exception
	 */
	public function setIndexByName ($sheetName,
									$newIndex) {
	...
	public function removeCellXfByIndex ($pIndex = 0) {
		if ($pIndex > count ($this->_cellXfCollection) - 1) {
			...
			array_splice ($this->_cellXfCollection,
						  $pIndex,
						  1);
	...
	public function removeCellStyleXfByIndex ($pIndex = 0) {
		if ($pIndex > count ($this->_cellStyleXfCollection) - 1) {
			...
			array_splice ($this->_cellStyleXfCollection,
						  $pIndex,
						  1);
		}
	}
