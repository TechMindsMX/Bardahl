...
class PHPExcel_Worksheet_PageSetup
{
	 ...
	 * @return PHPExcel_Worksheet_PageSetup
	 */
	public function setRowsToRepeatAtTopByStartAndEnd ($pStart = 1,
													   $pEnd = 1) {
	...
	public function setPrintArea ($value,
		...
		if ($method == self::SETPRINTRANGE_OVERWRITE) {
			...
			if ($index == 0) {
				...
				$printAreas = array_merge (array_slice ($printAreas,
														0,
														$index),
										   array ($value),
										   array_slice ($printAreas,
														$index));
				$this->_printArea = implode (',',
											 $printAreas);
			}
	 ...
	 * @throws    PHPExcel_Exception
	 */
	public function addPrintArea ($value,
								  $index = -1) {
		return $this->setPrintArea ($value,
									$index,
	 ...
	 * @throws    PHPExcel_Exception
	 */
	public function setPrintAreaByColumnAndRow ($column1,
												$row1,
												$column2,
												$row2,
												$index = 0,
	 ...
	 * @throws    PHPExcel_Exception
	 */
	public function addPrintAreaByColumnAndRow ($column1,
												$row1,
												$column2,
												$row2,
												$index = -1) {
