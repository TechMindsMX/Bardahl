...
class PHPExcel_Calculation_Financial
{
	 ...
	 * @return    float
	 */
	public static function ACCRINT ($issue,
									$firstinterest,
									$settlement,
									$rate,
									$par = 1000,
		...
		if ((is_numeric ($rate)) && (is_numeric ($par))) {
			...
			$daysBetweenIssueAndSettlement = PHPExcel_Calculation_DateTime::YEARFRAC ($issue,
																					  $settlement,
																					  $basis);
	 ...
	 * @return    float
	 */
	public static function ACCRINTM ($issue,
									 $settlement,
									 $rate,
									 $par = 1000,
									 $basis = 0) {
	 ...
	 * @return    float
	 */
	public static function AMORDEGRC ($cost,
									  $purchased,
									  $firstPeriod,
									  $salvage,
									  $period,
	 ...
	 * @return    float
	 */
	public static function AMORLINC ($cost,
									 $purchased,
									 $firstPeriod,
									 $salvage,
									 $period,
	 ...
	 */
	public static function COUPNCD ($settlement,
									$maturity,
									$frequency,
									$basis = 0) {
		$settlement = PHPExcel_Calculation_Functions::flattenSingleValue ($settlement);
		...
		return self::_coupFirstPeriodDate ($settlement,
										   $maturity,
										   $frequency,
										   True);
	...
	private static function _coupFirstPeriodDate ($settlement,
												  $maturity,
												  $frequency,
												  $next) {
		$months = 12 / $frequency;
	 ...
	 *                        depending on the value of the ReturnDateType flag
	 */
	public static function COUPPCD ($settlement,
									$maturity,
									$frequency,
									$basis = 0) {
		$settlement = PHPExcel_Calculation_Functions::flattenSingleValue ($settlement);
	 ...
	 * @return    float
	 */
	public static function CUMIPMT ($rate,
									$nper,
									$pv,
									$start,
									$end,
	 ...
	 * @return    float
	 */
	public static function IPMT ($rate,
								 $per,
								 $nper,
								 $pv,
								 $fv = 0,
		...
		// Calculate
		$interestAndPrincipal = self::_interestAndPrincipal ($rate,
															 $per,
															 $nper,
															 $pv,
															 $fv,
	...
	private static function _interestAndPrincipal ($rate = 0,
												   $per = 0,
												   $nper = 0,
												   $pv = 0,
												   $fv = 0,
	 ...
	 * @return    float
	 */
	public static function PMT ($rate = 0,
								$nper = 0,
								$pv = 0,
								$fv = 0,
								$type = 0) {
		...
		if (!is_null ($rate) && $rate != 0) {
			return (-$fv - $pv * pow (1 + $rate,
									  $nper)) / (1 + $rate * $type) / ((pow (1 + $rate,
																			 $nper) - 1) / $rate);
		} else {
			return (-$pv - $fv) / $nper;
		}
	 ...
	 * @return    float
	 */
	public static function CUMPRINC ($rate,
									 $nper,
									 $pv,
									 $start,
									 $end,
	 ...
	 * @return    float
	 */
	public static function PPMT ($rate,
								 $per,
								 $nper,
								 $pv,
								 $fv = 0,
	 ...
	 * @return    float
	 */
	public static function DB ($cost,
							   $salvage,
							   $life,
							   $period,
							   $month = 12) {
		...
		if ((is_numeric ($cost)) && (is_numeric ($salvage)) && (is_numeric ($life)) && (is_numeric ($period)) && (is_numeric ($month))) {
			...
			$fixedDepreciationRate = 1 - pow (($salvage / $cost),
					(1 / $life));
			$fixedDepreciationRate = round ($fixedDepreciationRate,
											3);
	 ...
	 * @return    float
	 */
	public static function DDB ($cost,
								$salvage,
								$life,
								$period,
								$factor = 2.0) {
	 ...
	 * @return    float
	 */
	public static function DISC ($settlement,
								 $maturity,
								 $price,
								 $redemption,
								 $basis = 0) {
	 ...
	 * @return    float
	 */
	public static function DOLLARDE ($fractional_dollar = Null,
									 $fraction = 0) {
	 ...
	 * @return    float
	 */
	public static function DOLLARFR ($decimal_dollar = Null,
									 $fraction = 0) {
	 ...
	 * @return    float
	 */
	public static function EFFECT ($nominal_rate = 0,
								   $npery = 0) {
		...
		return pow ((1 + $nominal_rate / $npery),
			$npery) - 1;
	}    //	function DISC()
	 ...
	 * @return    float
	 */
	public static function FV ($rate = 0,
							   $nper = 0,
							   $pmt = 0,
							   $pv = 0,
							   $type = 0) {
		...
		// Calculate
		if (!is_null ($rate) && $rate != 0) {
			return -$pv * pow (1 + $rate,
							   $nper) - $pmt * (1 + $rate * $type) * (pow (1 + $rate,
																		   $nper) - 1) / $rate;
		} else {
			return -$pv - $pmt * $nper;
		}
	 ...
	 * @return    float
	 */
	public static function FVSCHEDULE ($principal,
									   $schedule) {
	 ...
	 * @return    float
	 */
	public static function INTRATE ($settlement,
									$maturity,
									$investment,
									$redemption,
									$basis = 0) {
	...
	public static function IRR ($values,
		...
		for ($i = 0; $i < FINANCIAL_MAX_ITERATIONS; ++$i) {
			...
			if (abs ($f1) < abs ($f2)) {
				$f1 = self::NPV ($x1 += 1.6 * ($x1 - $x2),
								 $values);
			} else {
				$f2 = self::NPV ($x2 += 1.6 * ($x2 - $x1),
								 $values);
			}
		}
		if (($f1 * $f2) > 0.0) {
	...
	public static function NPV () {
		...
		for ($i = 1; $i <= count ($aArgs); ++$i) {
			...
			if (is_numeric ($aArgs[$i - 1])) {
				$returnValue += $aArgs[$i - 1] / pow (1 + $rate,
													  $i);
			}
		}
	 ...
	 * @return    float
	 */
	public static function MIRR ($values,
								 $finance_rate,
								 $reinvestment_rate) {
		if (!is_array ($values)) {
			return PHPExcel_Calculation_Functions::VALUE ();
	 ...
	 * @return    float
	 */
	public static function NOMINAL ($effect_rate = 0,
									$npery = 0) {
		...
		// Calculate
		return $npery * (pow ($effect_rate + 1,
							  1 / $npery) - 1);
	}    //	function IRR()
	 ...
	 * @return    float
	 */
	public static function NPER ($rate = 0,
								 $pmt = 0,
								 $pv = 0,
								 $fv = 0,
								 $type = 0) {
	...
	public static function PRICE ($settlement,
								  $maturity,
								  $rate,
								  $yield,
								  $redemption,
		...
		$dsc = self::COUPDAYSNC ($settlement,
								 $maturity,
								 $frequency,
								 $basis);
		$e = self::COUPDAYS ($settlement,
							 $maturity,
							 $frequency,
							 $basis);
		...
		$result = $redemption / pow ($baseYF,
				(--$n + $de));
		for ($k = 0; $k <= $n; ++$k) {
			$result += $rfp / (pow ($baseYF,
					($k + $de)));
		}
		$result -= $rfp * ($a / $e);
	 ...
	 * @return    float
	 */
	public static function COUPDAYSNC ($settlement,
									   $maturity,
									   $frequency,
									   $basis = 0) {
		$settlement = PHPExcel_Calculation_Functions::flattenSingleValue ($settlement);
		...
		$daysPerYear = self::_daysPerYear (PHPExcel_Calculation_DateTime::YEAR ($settlement),
										   $basis);
		$next = self::_coupFirstPeriodDate ($settlement,
											$maturity,
											$frequency,
											True);

		return PHPExcel_Calculation_DateTime::YEARFRAC ($settlement,
														$next,
														$basis) * $daysPerYear;
	}    //	function NOMINAL()
	 ...
	 * @return    integer
	 */
	private static function _daysPerYear ($year,
										  $basis = 0) {
		switch ($basis) {
			case 0 :
			case 2 :
	 ...
	 * @return    float
	 */
	public static function COUPDAYS ($settlement,
									 $maturity,
									 $frequency,
									 $basis = 0) {
		$settlement = PHPExcel_Calculation_Functions::flattenSingleValue ($settlement);
		...
		switch ($basis) {
			...
			case 1: // Actual/actual
				if ($frequency == 1) {
					$daysPerYear = self::_daysPerYear (PHPExcel_Calculation_DateTime::YEAR ($maturity),
													   $basis);
					return ($daysPerYear / $frequency);
				} else {
					$prev = self::_coupFirstPeriodDate ($settlement,
														$maturity,
														$frequency,
														False);
					$next = self::_coupFirstPeriodDate ($settlement,
	 ...
	 * @return    integer
	 */
	public static function COUPNUM ($settlement,
									$maturity,
									$frequency,
									$basis = 0) {
		$settlement = PHPExcel_Calculation_Functions::flattenSingleValue ($settlement);
		...
		$settlement = self::_coupFirstPeriodDate ($settlement,
												  $maturity,
												  $frequency,
												  True);
		$daysBetweenSettlementAndMaturity = PHPExcel_Calculation_DateTime::YEARFRAC ($settlement,
	 ...
	 * @return    float
	 */
	public static function COUPDAYBS ($settlement,
									  $maturity,
									  $frequency,
									  $basis = 0) {
		$settlement = PHPExcel_Calculation_Functions::flattenSingleValue ($settlement);
		...
		return PHPExcel_Calculation_DateTime::YEARFRAC ($prev,
														$settlement,
														$basis) * $daysPerYear;
	}    //	function PPMT()
	 ...
	 * @return    float
	 */
	public static function PRICEDISC ($settlement,
									  $maturity,
									  $discount,
									  $redemption,
									  $basis = 0) {
	 ...
	 * @return    float
	 */
	public static function PRICEMAT ($settlement,
									 $maturity,
									 $issue,
									 $rate,
									 $yield,
		...
		if (is_numeric ($rate) && is_numeric ($yield)) {
			...
			$daysBetweenIssueAndMaturity = PHPExcel_Calculation_DateTime::YEARFRAC ($issue,
																					$maturity,
																					$basis);
	 ...
	 * @return    float
	 */
	public static function PV ($rate = 0,
							   $nper = 0,
							   $pmt = 0,
							   $fv = 0,
							   $type = 0) {
	 ...
	 * @return    float
	 **/
	public static function RATE ($nper,
								 $pmt,
								 $pv,
								 $fv = 0.0,
								 $type = 0,
	 ...
	 * @return    float
	 */
	public static function RECEIVED ($settlement,
									 $maturity,
									 $investment,
									 $discount,
									 $basis = 0) {
	 ...
	 * @return    float
	 */
	public static function SLN ($cost,
								$salvage,
								$life) {
		$cost = PHPExcel_Calculation_Functions::flattenSingleValue ($cost);
		$salvage = PHPExcel_Calculation_Functions::flattenSingleValue ($salvage);
	 ...
	 * @return    float
	 */
	public static function SYD ($cost,
								$salvage,
								$life,
								$period) {
		$cost = PHPExcel_Calculation_Functions::flattenSingleValue ($cost);
	 ...
	 * @return    float
	 */
	public static function TBILLEQ ($settlement,
									$maturity,
									$discount) {
		$settlement = PHPExcel_Calculation_Functions::flattenSingleValue ($settlement);
		$maturity = PHPExcel_Calculation_Functions::flattenSingleValue ($maturity);
		...
		$testValue = self::TBILLPRICE ($settlement,
									   $maturity,
									   $discount);
	 ...
	 * @return    float
	 */
	public static function TBILLPRICE ($settlement,
									   $maturity,
									   $discount) {
		$settlement = PHPExcel_Calculation_Functions::flattenSingleValue ($settlement);
		$maturity = PHPExcel_Calculation_Functions::flattenSingleValue ($maturity);
	 ...
	 * @return    float
	 */
	public static function TBILLYIELD ($settlement,
									   $maturity,
									   $price) {
		$settlement = PHPExcel_Calculation_Functions::flattenSingleValue ($settlement);
		$maturity = PHPExcel_Calculation_Functions::flattenSingleValue ($maturity);
	...
	public static function XIRR ($values,
		...
		for ($i = 0; $i < FINANCIAL_MAX_ITERATIONS; ++$i) {
			...
			if (abs ($f1) < abs ($f2)) {
				$f1 = self::XNPV ($x1 += 1.6 * ($x1 - $x2),
								  $values,
								  $dates);
			} else {
				$f2 = self::XNPV ($x2 += 1.6 * ($x2 - $x1),
								  $values,
								  $dates);
			}
		}
	 ...
	 * @return    float
	 */
	public static function XNPV ($rate,
								 $values,
								 $dates) {
		$rate = PHPExcel_Calculation_Functions::flattenSingleValue ($rate);
		if (!is_numeric ($rate)) {
	 ...
	 * @return    float
	 */
	public static function YIELDDISC ($settlement,
									  $maturity,
									  $price,
									  $redemption,
									  $basis = 0) {
	 ...
	 * @return    float
	 */
	public static function YIELDMAT ($settlement,
									 $maturity,
									 $issue,
									 $rate,
									 $price,
