...
class PHPExcel_Calculation_TextData
{
	...
	public static function CHARACTER ($character) {
		...
		if (function_exists ('mb_convert_encoding')) {
			return mb_convert_encoding ('&#' . intval ($character) . ';',
										'UTF-8',
										'HTML-ENTITIES');
		} else {
	...
	public static function TRIMNONPRINTABLE ($stringValue = '') {
		...
		if (self::$_invalidChars == Null) {
			self::$_invalidChars = range (chr (0),
										  chr (31));
		}
	...
	public static function ASCIICODE ($characters) {
		...
		if ((function_exists ('mb_strlen')) && (function_exists ('mb_substr'))) {
			if (mb_strlen ($characters,
						   'UTF-8') > 1
			) {
				$character = mb_substr ($characters,
										0,
										1,
										'UTF-8');
			}
	 ...
	 * @return    string
	 */
	public static function DOLLAR ($value = 0,
								   $decimals = 2) {
	 ...
	 * @return    string
	 */
	public static function SEARCHSENSITIVE ($needle,
											$haystack,
											$offset = 1) {
	 ...
	 * @return    string
	 */
	public static function SEARCHINSENSITIVE ($needle,
											  $haystack,
											  $offset = 1) {
		$needle = PHPExcel_Calculation_Functions::flattenSingleValue ($needle);
		$haystack = PHPExcel_Calculation_Functions::flattenSingleValue ($haystack);
	 ...
	 * @return    boolean
	 */
	public static function FIXEDFORMAT ($value,
										$decimals = 2,
										$no_commas = FALSE) {
		$value = PHPExcel_Calculation_Functions::flattenSingleValue ($value);
	 ...
	 * @return    string
	 */
	public static function MID ($value = '',
								$start = 1,
								$chars = null) {
		$value = PHPExcel_Calculation_Functions::flattenSingleValue ($value);
	 ...
	 * @return    string
	 */
	public static function SUBSTITUTE ($text = '',
									   $fromText = '',
									   $toText = '',
									   $instance = 0) {
		...
		if ($instance == 0) {
			if (function_exists ('mb_str_replace')) {
				return mb_str_replace ($fromText,
									   $toText,
									   $text);
			} else {
				return str_replace ($fromText,
									$toText,
									$text);
			}
		} else {
	 ...
	 * @return    string
	 */
	public static function REPLACE ($oldText = '',
									$start = 1,
									$chars = null,
									$newText) {
