...
class PHPExcel_Writer_Excel2007_Theme extends PHPExcel_Writer_Excel2007_WriterPart
{
	...
	public function writeTheme (PHPExcel $pPHPExcel = null) {
		...
		$objWriter->writeAttribute ('ang',
									'16200000');
		$objWriter->writeAttribute ('scaled',
									'1');
		$objWriter->endElement ();
		...
		$objWriter->writeAttribute ('lat',
									'0');
		$objWriter->writeAttribute ('lon',
									'0');
	 ...
	 * @throws    PHPExcel_Writer_Exception
	 */
	private function _writeFonts ($objWriter,
								  $latinFont,
								  $fontSet) {
		// a:latin
		...
		foreach ($fontSet as $fontScript => $typeface) {
			...
			$objWriter->writeAttribute ('script',
										$fontScript);
			$objWriter->writeAttribute ('typeface',
										$typeface);
			$objWriter->endElement ();
