...
class PHPExcel_Writer_Excel2007_Comments extends PHPExcel_Writer_Excel2007_WriterPart
{
	...
	public function writeVMLComments (PHPExcel_Worksheet $pWorksheet = null) {
		...
		// Loop through comments
		foreach ($comments as $key => $value) {
			$this->_writeVMLComment ($objWriter,
									 $key,
									 $value);
		}
	...
	public function _writeVMLComment (PHPExcel_Shared_XMLWriter $objWriter = null,
		...
		$objWriter->writeAttribute ('on',
									't');
		$objWriter->writeAttribute ('color',
									'black');
		$objWriter->writeAttribute ('obscured',
									't');
		$objWriter->endElement ();
		...
		// x:Row
		$objWriter->writeElement ('x:Row',
			($row - 1));

		// x:Column
		$objWriter->writeElement ('x:Column',
			($column - 1));
