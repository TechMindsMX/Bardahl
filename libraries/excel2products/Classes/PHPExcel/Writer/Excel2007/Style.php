...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart
{
	...
	public function writeStyles (PHPExcel $pPHPExcel = null) {
		...
		foreach ($pPHPExcel->getCellXfCollection () as $cellXf) {
			$this->_writeCellStyleXf ($objWriter,
									  $cellXf,
									  $pPHPExcel);
		}
		...
		$objWriter->writeAttribute ('name',
									'Normal');
		$objWriter->writeAttribute ('xfId',
									0);
		$objWriter->writeAttribute ('builtinId',
									0);
		$objWriter->endElement ();
	...
	private function _writeFill (PHPExcel_Shared_XMLWriter $objWriter = null,
		...
		if ($pFill->getFillType () === PHPExcel_Style_Fill::FILL_GRADIENT_LINEAR ||
			...
			// Gradient fill
			$this->_writeGradientFill ($objWriter,
									   $pFill);
		} elseif ($pFill->getFillType () !== NULL) {
			// Pattern fill
			$this->_writePatternFill ($objWriter,
									  $pFill);
		}
	}
	...
	private function _writeGradientFill (PHPExcel_Shared_XMLWriter $objWriter = null,
		...
		$objWriter->writeAttribute ('position',
									'0');
	 ...
	 * @throws    PHPExcel_Writer_Exception
	 */
	private function _writePatternFill (PHPExcel_Shared_XMLWriter $objWriter = null,
										PHPExcel_Style_Fill $pFill = null) {
		// fill
		$objWriter->startElement ('fill');
	 ...
	 * @throws    PHPExcel_Writer_Exception
	 */
	private function _writeCellStyleXf (PHPExcel_Shared_XMLWriter $objWriter = null,
		...
		if ($pStyle->getQuotePrefix ()) {
			$objWriter->writeAttribute ('quotePrefix',
										1);
		}
	 ...
	 * @throws    PHPExcel_Writer_Exception
	 */
	private function _writeCellStyleDxf (PHPExcel_Shared_XMLWriter $objWriter = null,
										 PHPExcel_Style $pStyle = null) {
		// dxf
