...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
	    ...
	    if(!defined('JPATH_BASE') AND session_id() == '' ) { // no session has been started yet, which is needed for validation
	...
	function validate()
	{
		...
		//echo 'defined('JPATH_BASE')='.CAPTCHA_SESSION_METHOD.'<pre>'; print_r($_SESSION); exit;
		if ($code != '') {
