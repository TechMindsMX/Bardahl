...
function showbiz_showDoubleJqueryError(sliderID) {
	var errorMessage = "Showbiz Error: You have some jquery.js library include that comes after the showbiz files js include.";
	errorMessage += "<br> This includes make eliminates the showbiz libraries, and make it not work.";
	errorMessage += "<br><br> To fix it you can:<br>&nbsp;&nbsp;&nbsp; 1. In the Slider showbiz module set option:  <strong><b>Put JS Includes To Body</b></strong> option to true.";
