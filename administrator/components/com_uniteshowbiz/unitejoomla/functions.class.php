...
class UniteFunctionsShowbiz {
    ...
    public static function jsonEncodeForClientSide($arr) {
        ...
        if (!is_array($arr) && !is_object($arr))
            UniteFunctionsShowbiz::throwError("The input must be array: ");
    ...
    public static function trimArrayItems($arr) {
        if (gettype($arr) != "array")
            UniteFunctionsShowbiz::throwError("trimArrayItems error: The type must be array");
